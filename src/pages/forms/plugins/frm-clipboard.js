...
const ClipboardPage = () => {
  ...
  return (
    <Page title="Clipboard">
      <MainCard
        title="Clipboard"
        secondary={<SecondaryAction icon={<LinkIcon fontSize="small" />} link="https://www.npmjs.com/package/react-copy-to-clipboard" />}
      >
...
ClipboardPage.getLayout = function getLayout(page) {
